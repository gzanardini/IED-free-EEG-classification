...
#         # Save the features
#         np.save(os.path.join(feature_path, f'spectral_{montage}_{segment_length}.npy'), spectral_features)
...
#         # Save the features
#         np.save(os.path.join(feature_path, f'cwt_{montage}_{segment_lenght}.npy'), cwt_features)
...
#         print(f'Finished processing montage: {montage}, segment length: {segment_lenght}')
#         # Save the features
#         np.save(os.path.join(feature_path, f'dwt_{montage}_{segment_lenght}.npy'), dwt_features)

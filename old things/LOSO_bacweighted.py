...
for run_n in range(N_RUNS):    
    ...
    run_summary.to_csv(f'/space/gzanardini/loso_logs_ensemble/BAC_weighted_run_{run_n}_seed_{seed}.csv', index=False)    
    prediction_summary.to_csv(f'/space/gzanardini/loso_logs_ensemble/BAC_weighted_run_{run_n}_predictions_seed_{seed}.csv', index=False)

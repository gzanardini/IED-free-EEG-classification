"""
Preprocessing module for TUH Epilepsy Dataset.

This module provides comprehensive preprocessing functions for the TUH Epilepsy dataset,
including dataset loading, filtering, EEG signal preprocessing, and photostimulation
